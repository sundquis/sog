	...
	public static abstract class Container {
		...
		public void setSubjectField( Object subject, String fieldName, Object fieldValue ) {
			try {
				...
				throw new AppRuntime( "Bad field name: " + fieldName, e );
			} catch ( IllegalAccessException e ) {
				Fatal.impossible( "After setAccessible should not happen?", e );
			} catch ( NullPointerException e ) {
				throw new AppRuntime( "Instance field requires non-null subject", e );
			} catch ( IllegalArgumentException e ) {
				throw new AppRuntime( "Wrong type value supplied to " + fieldName, e );
			}
		}
		...
		@Test.Decl( "Throws AppRuntime for no matching method" )
		@Test.Decl( "Throws ClassCastException for wrong witness type" )
		@Test.Decl( "Throws Error generated by method")
		@Test.Decl( "Throws RuntimeException generated by method")
		@Test.Decl( "Wraps Exception generated by method in AppRuntime")
		...
		public <T> T evalSubjectMethod( Object subject, String methodName, T returnWitness, Object... args ) {
			...
			while ( searching && methods.hasNext() ) {
				...
				try {
					...
					throw new AppRuntime( "Instance method requires non-null subject", e );
			...
			if ( searching ) {
				throw new AppRuntime( "No matching method: " + methodName );
			}
