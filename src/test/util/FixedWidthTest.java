...
public class FixedWidthTest implements TestContainer {
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.defaultFieldSeparator(String)", desc = "Applied to remaining fields" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.defaultFieldSeparator(String)", desc = "Can be emtpty" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.defaultFieldSeparator(String)", desc = "If not specified, default is empty string" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.defaultFieldSeparator(String)", desc = "Overrides default empty" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.defaultFieldSeparator(String)", desc = "Previous fields unaffected" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.defaultFieldSeparator(String)", desc = "Throws assertion error for null" )
	...
	// left(int, char)
	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char)", desc = "Appends left justified field" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char)", desc = "Padding character is used" )
	public void left_PaddingCharacterIsUsed( TestCase tc ) {
		this.formatter.left( 5,  'X' );
		tc.assertEqual( "FOOXX",  this.formatter.format( "FOO" ) );
	}

	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char)", desc = "Width must be positive" )
	public void left_WidthMustBePositive( TestCase tc ) {
		tc.expectError( AssertionError.class );
		this.formatter.left( -1,  '0' );
	}

	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char)", desc = "Truncated for long" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char)", desc = "Width is correct for short" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char, Function)", desc = "Other fields unaffected" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char, Function)", desc = "Representation overrides toString() for this field" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.left(int, char, Function)", desc = "Throws assertion error for null representation" )
	...
	// nullFields(String)
	@Test.Impl( src = "public FixedWidth FixedWidth.nullFields(String)", desc = "Applied to remaining fields" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.nullFields(String)", desc = "Can be empty" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.nullFields(String)", desc = "If not specified, default is empty string" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.nullFields(String)", desc = "Overrides default empty" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.nullFields(String)", desc = "Previous fields unaffected" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.nullFields(String)", desc = "Throws assertion error for null" )
	...
	// right(int, char)
	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char)", desc = "Appends right justified field" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char)", desc = "Padding character is used" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char)", desc = "Width must be positive" )
	public void right_WidthMustBePositive( TestCase tc ) {
		tc.expectError( AssertionError.class );
		this.formatter.right( -1,  '0' );
	}

	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char)", desc = "Truncated for long" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char)", desc = "Width is correct for short" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char, Function)", desc = "Other fields unaffected" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char, Function)", desc = "Representation overrides toString() for this field" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.right(int, char, Function)", desc = "Throws assertion error for null representation" )
	...
	// sep(String)
	@Test.Impl( src = "public FixedWidth FixedWidth.sep(String)", desc = "Appends if last" )
	public void sep_AppendsIfLast( TestCase tc ) {
		this.formatter.right( 4,  '0' ).sep( "FOO" );
		tc.assertEqual( "0001FOO",  this.formatter.format( 1 ) );
	}

	@Test.Impl( src = "public FixedWidth FixedWidth.sep(String)", desc = "Can be empty" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.sep(String)", desc = "Does not affect subsequent separators" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.sep(String)", desc = "Multiple separators allowed" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.sep(String)", desc = "Overrides default" )
	...
	@Test.Impl( src = "public FixedWidth FixedWidth.sep(String)", desc = "Throws assertion error for null separator" )
	...
	// FixedWidth()
	@Test.Impl( src = "public FixedWidth()", desc = "Empty formatter produces empty formatted string" )
	...
	// format(Object[])
	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Fields are separated as specified" )
	public void format_FieldsAreSeparatedAsSpecified( TestCase tc ) {
		this.formatter.right( 5,  ' ' ).sep( "---" ).left( 5,  ' ' );
		tc.assertEqual( "    >---<    ",  this.formatter.format( ">", "<" ) );
	}

	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Fields can be added after formatting" )
	...
	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Fields formatted in the order specified" )
	...
	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Non null fields represented appropriately" )
	...
	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Null fields use null representation" )
	...
	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Throws illegal argument exception for too few fields" )
	...
	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Throws illegal argument exception for too many fields" )
	...
	@Test.Impl( src = "public String FixedWidth.format(Object[])", desc = "Throws class cast exception for wron argument type" )
	...
	// length()
	@Test.Impl( src = "public int FixedWidth.length()", desc = "Includes fields" )
	...
	@Test.Impl( src = "public int FixedWidth.length()", desc = "Includes separators" )
	public void length_IncludesSeparators( TestCase tc ) {
		this.formatter.right( 20,  ' ' ).sep( "12" ).left( 20,  ' ' );
		tc.assertEqual( 42,  this.formatter.length() );
	}

	@Test.Impl( src = "public int FixedWidth.length()", desc = "Increases when field appended" )
	...
	@Test.Impl( src = "public int FixedWidth.length()", desc = "Increses when separator appended" )
	...
	// toString()
	@Test.Impl( src = "public String FixedWidth.toString()", desc = "Includes field count" )
	...
	@Test.Impl( src = "public String FixedWidth.toString()", desc = "Includes length" )
