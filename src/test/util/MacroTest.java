...
public class MacroTest implements TestContainer {
	...
	@Test.Impl( src = "public Macro Macro.expand(String, List)", desc = "Any value may be empty" )
	public void expand_AnyValueMayBeEmpty( TestCase tc ) {
		new Macro().expand( "X",  Arrays.asList( "A", "", "B" ) );
		tc.pass();
	}

	@Test.Impl( src = "public Macro Macro.expand(String, List)", desc = "Empty value collection allowed" )
	public void expand_EmptyValueCollectionAllowed( TestCase tc ) {
		new Macro().expand( "A",  new ArrayList<String>() );
		tc.pass();
	}

	@Test.Impl( src = "public Macro Macro.expand(String, List)", desc = "Returns this instance" )
	public void expand_ReturnsThisInstance( TestCase tc ) {
		Macro macro = new Macro();
		tc.assertEqual( macro,  macro.expand( "A",  new ArrayList<String>() ) );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, List)", desc = "Throws assertion error for a null value" )
	public void expand_ThrowsAssertionErrorForANullValue( TestCase tc ) {
		tc.expectError( AssertionError.class );
		new Macro().expand( "A",  Arrays.asList( "A", null, "B" ) );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, List)", desc = "Throws assertion error for null collection of values" )
	...
	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Any value may be empty" )
	public void expand_AnyValueMayBeEmpty_( TestCase tc ) {
		new Macro().expand( "X",  new String[] { "A", "", "B" } );
		tc.pass();
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Dollar wihtin key not allowed" )
	public void expand_DollarWihtinKeyNotAllowed( TestCase tc ) {
		tc.expectError( AssertionError.class );
		new Macro().expand( "$hi",  "hi" );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Empty value sequence allowed" )
	public void expand_EmptyValueSequenceAllowed( TestCase tc ) {
		new Macro().expand( "A",  new String[] {} );
		tc.pass();
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Key does not end with white space" )
	public void expand_KeyDoesNotEndWithWhiteSpace( TestCase tc ) {
		tc.expectError( AssertionError.class );
		new Macro().expand( "foo ",  "" );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Key does not start with white space" )
	public void expand_KeyDoesNotStartWithWhiteSpace( TestCase tc ) {
		tc.expectError( AssertionError.class );
		new Macro().expand( " foo",  "" );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Left brace in key not allowed" )
	public void expand_LeftBraceInKeyNotAllowed( TestCase tc ) {
		tc.expectError( AssertionError.class );
		new Macro().expand( "f{o",  "" );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Replacement rules can be over-written" )
	...
	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Returns this instance" )
	public void expand_ReturnsThisInstance_( TestCase tc ) {
		Macro macro = new Macro();
		tc.assertEqual( macro,  macro.expand( "A",  "" ) );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Right brace in key not allowed" )
	public void expand_RightBraceInKeyNotAllowed( TestCase tc ) {
		tc.expectError( AssertionError.class );
		new Macro().expand( "a}a",  "a", "b" );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Special characters in key allowed" )
	public void expand_SpecialCharactersInKeyAllowed( TestCase tc ) {
		new Macro().expand( "a!@##%^&*()-_=+[];:',<.>/?",  "a", "b" );
		tc.pass();
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Throws AssertionError for empty key" )
	public void expand_ThrowsAssertionerrorForEmptyKey( TestCase tc ) {
		tc.expectError( AssertionError.class );
		new Macro().expand( "",  "A", "S" );
	}

	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Throws assertion error for a null value" )
	...
	@Test.Impl( src = "public Macro Macro.expand(String, String[])", desc = "Whitespace in key is allowed" )
	public void expand_WhitespaceInKeyIsAllowed( TestCase tc ) {
		new Macro().expand( "SPA  CE",  "A", "A" );
		tc.pass();
	}

	@Test.Impl( src = "public Macro()", desc = "Stateless instance acts as identity function" )
	...
	@Test.Impl( src = "public Stream Macro.apply(List)", desc = "An empty collection produces an empty stream" )
	...
	@Test.Impl( src = "public Stream Macro.apply(List)", desc = "An empty expansion rule removes line from output stream" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Can trigger recursion exception through excessive replacements" )
	...
	@Test.Impl( src = "public Stream Macro.apply(List)", desc = "Multiple lines in output for multiple input lines" )
	...
	@Test.Impl( src = "public Stream Macro.apply(List)", desc = "Throws AppException for excessive recursion" )
	...
	@Test.Impl( src = "public Stream Macro.apply(List)", desc = "Throws Assertion Error for null lines" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "All keys replaced in output stream" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "An empty expansion rule produces an empty stream" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Input line without keys is unchanged" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Mal-formed patterns are ignored" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Multiple keys replaced" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Multiple lines in output for multiple replacements" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "One letter keys work" )
	public void apply_OneLetterKeysWork( TestCase tc ) {
		tc.assertEqual( 6,  new Macro().expand( "X",  "XXX" ).apply( "${X}${X}" ).findFirst().orElse( "" ).length() );
	}

	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Replacement within replacement allowed" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Simple replacement works" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Throws AppException for excessive recursion" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Throws AppExcpetion for missing key" )
	public void apply_ThrowsAppexcpetionForMissingKey( TestCase tc ) {
		tc.expectError( AppException.class );
		new Macro().apply( "${missing}" );
	}

	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Throws AssertionError for null line" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String)", desc = "Works with flatMap to expand a stream" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String[])", desc = "An empty expansion rule removes line from output stream" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String[])", desc = "An empty sequence of lines produces an empty stream" )
	...
	@Test.Impl( src = "public Stream Macro.apply(String[])", desc = "Multiple lines in output for multiple input lines" )
