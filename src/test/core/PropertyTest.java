...
public class PropertyTest implements TestContainer {
	...
	@Test.Impl( src = "public String Property.getText(String)", desc = "Prints declaration for missing property" )
	...
	@Test.Impl( src = "public String Property.getText(String)", desc = "Retrieves text for double nested classes" )
	public void getText_RetrievesTextForDoubleNestedClasses( TestCase tc ) {
		tc.assertTrue( Inner.getTestText().length() > 0 );
	}

	@Test.Impl( src = "public String Property.getText(String)", desc = "Retrieves text for nested classes" )
	public void getText_RetrievesTextForNestedClasses( TestCase tc ) {
		tc.assertEqual( "Nested",  Property.getText( "nested" ) );
	}

	@Test.Impl( src = "public String Property.getText(String)", desc = "Retrieves text for top level classes" )
	public void getText_RetrievesTextForTopLevelClasses( TestCase tc ) {
		tc.assertTrue( XML.get().getDeclaration().length() > 0 );
	}

	@Test.Impl( src = "public String Property.getText(String)", desc = "Throws assertion error for anonymous classes" )
	...
	@Test.Impl( src = "public String Property.getText(String)", desc = "Throws assertion error for empty name" )
	public void getText_ThrowsAssertionErrorForEmptyName( TestCase tc ) {
		tc.expectError( AssertionError.class );
		Property.getText( "" );
	}

	@Test.Impl( src = "public String Property.getText(String)", desc = "Throws assertion error for local classs" )
	...
	@Test.Impl( src = "public String Property.getText(String)", desc = "Throws assertion error for null name" )
	public void getText_ThrowsAssertionErrorForNullName( TestCase tc ) {
		tc.expectError( AssertionError.class );
		Property.getText( null );
	}
	
	@Test.Impl( src = "public Object Property.get(String, Object, Function)", desc = "Last value for multiple elements" )
	public void get_LastValueForMultipleElements( TestCase tc ) {
		tc.assertTrue( Property.get( "duplicate",  false,  Property.BOOLEAN ) );
	}

	@Test.Impl( src = "public String Property.getText(String)", desc = "Can retrieve empty" )
	public void getText_CanRetrieveEmpty( TestCase tc ) {
		tc.assertTrue( "".equals( Property.getText( "empty" ) ) );
	}

	@Test.Impl( src = "public String Property.getText(String)", desc = "Can use property name" )
	public void getText_CanUsePropertyName( TestCase tc ) {
		tc.assertEqual( "Duplicate", Property.getText( "duplicate" ) );
	}

	@Test.Impl( src = "public String Property.getText(String)", desc = "Last value for multiple elements" )
	public void getText_LastValueForMultipleElements( TestCase tc ) {
		tc.assertEqual( "Repeated", Property.getText( "repeated" ) );
	}
	
	@Test.Impl( src = "public Object Property.get(String, Object, Function)", desc = "Uses default for missing" )
	...
	@Test.Impl( src = "public Object Property.get(String, Object, Function)", desc = "Throws exception for malformed integer" )
	...
	@Test.Impl( src = "public Object Property.get(String, Object, Function)", desc = "Throws exception for malformed long" )
