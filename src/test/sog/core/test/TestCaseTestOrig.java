...
public class TestCaseTestOrig extends Test.Container {
	...
	public Procedure beforeEach() {
		return () -> { TestCaseTestOrig.this.test = TestCaseTestOrig.this.getTestCase( "method1" ); };
	}
	
	@Override
	public Procedure afterEach() {
		return () -> { TestCaseTestOrig.this.test = null; };
	}
	...
	public void toString_StartsWithFailIfFailed( Test.Case tc ) {
		tc.assertTrue( this.test.assertTrue( false ).toString().startsWith( "FAIL" ) );
	}
	...
	public void fail_MarksLocationOfFailure( Test.Case tc ) {
		tc.assertIsNull( this.container.getSubjectField( this.test, "fileLocation", "" ) );
		this.test.assertTrue( false );
		tc.assertNonNull( this.container.getSubjectField( this.test, "fileLocation", "" ) );
	}
	...
	public void isNull_ReturnIsThis( Test.Case tc ) {
		tc.assertTrue( this.test == this.test.assertIsNull( "" ) );
	}
	...
	public void notEmpty_ReturnIsThis( Test.Case tc ) {
		tc.assertTrue( this.test == this.test.assertNotEmpty( "" ) );
	}
	...
	public void notNull_ReturnIsThis( Test.Case tc ) {
		tc.assertTrue( this.test == this.test.assertNonNull( null ) );
	}
